...
> Note: This package does note include any styling by default. You can use [react-contextmenu-fsght.css](https://github.com/docduck/react-contextmenu-fsght/blob/master/examples/react-contextmenu.css) from examples for quick setup.
